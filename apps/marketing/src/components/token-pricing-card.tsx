    ...
    <article className="glass-panel reveal rounded-[1.6rem] p-6 sm:p-8" style={{ animationDelay: "560ms" }}>
      ...
      <div className="mt-5 grid gap-4 sm:grid-cols-2">
        <div className="rounded-2xl border border-border/70 bg-background/55 p-4">
          ...
          <p className="mt-2 text-xs text-muted-foreground">Move the slider to estimate token balance.</p>
        </div>
        ...
        <div className="rounded-2xl border border-border/70 bg-background/55 p-4">
          ...
          <p className="mt-2 text-xs text-muted-foreground">
            At this balance you can run up to {integerFormatter.format(fullRuns)} full upload + segmentation cycles.
          </p>
        </div>
      </div>
