...
export function LiveDemo() {
	...
	useEffect(() => {
		...
		const timeout = setTimeout(
			() => reset(setPhase, setDisplayedText, charIndex),
			DONE_HOLD,
		);
		return () => clearTimeout(timeout);
	}, [phase]);
	...
	return (
		<div ref={containerRef} className="reveal space-y-3 rounded-[1.6rem] border border-border/70 bg-[#090b10]/60 p-3 sm:p-4">
