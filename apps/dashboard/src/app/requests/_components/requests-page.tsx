        ...
        <CardContent className="space-y-3">
          <div className="space-y-3 md:hidden">
            {jobs.length === 0 ? (
              ...
              jobs.map((job) => (
                <article key={job.id} className="rounded-xl border border-border/70 bg-card/55 p-3">
                  <p className="font-mono text-[11px] uppercase tracking-[0.12em] text-muted-foreground">
                    Request ID
                  </p>
                  <p className="mt-1 break-all font-mono text-xs text-foreground">{job.requestId}</p>
                  ...
                  <div className="mt-3 grid gap-2 sm:grid-cols-2">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-xs text-muted-foreground">{formatDate(job.createdAt)}</p>
                    </div>
                  </div>
                  <Button
                    variant="ghost"
